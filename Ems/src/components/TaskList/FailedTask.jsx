...
const FailedTask = ({ task }) => {
    return (
        <div className="task shrink-0 rounded-2xl w-80 p-6 bg-gradient-to-br from-amber-500 to-orange-600 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
